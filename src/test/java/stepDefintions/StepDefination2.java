...
public class StepDefination2 {
	...
	// Creating object of the Pageobjectmanager class in order perform specific operation across all the pages 
	    ...
	    @Given("^I  Login Application_Second with username as \"(.*?)\" and password as \"(.*?)\" and URL as \"(.*?)\"in browser \"(.*?)\" and node \"(.*?)\"$")
	public void i_Login_Application2nd_with_username_as_and_password_as_and_URL_as(String username, String password,String URLFirst,String browser ,String node) throws Throwable {
	...
	public void i_click_login_button_application2nd() throws Throwable {
		//pageobjmanager.getLoginPage().ClickLogin();
	}

	@And("^I signout from application2$")
	public void I_signout_from_application2nd() throws Throwable {
	...
	*/
	@Then("^I pass the info to next Application2 with URL \"(.*?)\"in browser \"(.*?)\" and node \"(.*?)\"$")
	public void i_pass_the_info_to_Second_application2nd_with_URL(String URLSecond,String browser ,String node) throws Throwable {
